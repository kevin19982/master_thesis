...
ggplot(data_recoded %>% filter(Country_Name %in% c("Germany", "Costa Rica")),
...
data_standardized <- data_model[, c("decision", "lfdn", "choice", var_list)]

standardize_data <- function(dataset){
  numeric_cols_temp <- dataset %>% select_if(is.numeric) %>% colnames()
...
data_model <- standardize_data(data_standardized)
